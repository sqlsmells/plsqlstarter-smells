...
,app_cd                         VARCHAR2(5 CHAR) NOT NULL
,app_nm                         VARCHAR2(50 CHAR) NOT NULL
,app_descr                      VARCHAR2(4000 CHAR) NOT NULL
)
...
,db_nm                         VARCHAR2(20 CHAR) NOT NULL
,db_descr                      VARCHAR2(500 CHAR) NOT NULL
...
,env_nm                        VARCHAR2(80 CHAR) NOT NULL
,db_id                         INTEGER NOT NULL
,app_version                   VARCHAR2(20 CHAR)                        
,owner_account                 VARCHAR2(30 CHAR) NOT NULL
...
(
 parm_id                       INTEGER NOT NULL
,parm_nm                       VARCHAR2(500 CHAR) NOT NULL
...
,app_id                         NUMBER NOT NULL
,email_to                       VARCHAR2(4000 CHAR) NOT NULL
,email_subject                  VARCHAR2(500  CHAR) NOT NULL
...
,sent_status                    VARCHAR2(20) DEFAULT 'Not Sent' NOT NULL
,sent_dt                        DATE
,smtp_error                     VARCHAR2(4000 CHAR)
,otx_sync_col                   VARCHAR2(1) DEFAULT 'N' NOT NULL
)
TABLESPACE &&default_tablespace
PCTFREE 10 PCTUSED 90
/
...
(
 email_doc_id                   NUMBER NOT NULL
,email_id                       NUMBER NOT NULL
,file_nm                        VARCHAR2(1024 CHAR) NOT NULL
,doc_content                    BLOB
,doc_size                       NUMBER
...
--  lang_nm                       VARCHAR2(255 CHAR) NOT NULL,
...
--,codeset_id                     INTEGER NOT NULL
--,code_val                       VARCHAR2(30 CHAR) NOT NULL
--,code_defn                      VARCHAR2(255 CHAR)
--,display_order                  INTEGER
--,editable_flg                   VARCHAR2(1) DEFAULT 'N' NOT NULL
...
,app_id                         NUMBER NOT NULL
,lock_nm                        VARCHAR2(255 CHAR) NOT NULL
,locked_obj_id                  VARCHAR2(60 CHAR)
,locked_obj_rid                 UROWID
,locker_ip                      VARCHAR2(40 BYTE)
,locker_id                      VARCHAR2(64 CHAR) NOT NULL
,locked_dtm                     DATE NOT NULL
)
TABLESPACE &&default_tablespace
...
,app_id                         NUMBER NOT NULL
,msg_cd                         VARCHAR2(60 CHAR) NOT NULL
,msg                            VARCHAR2(255 CHAR) NOT NULL
...
,sev_cd                         VARCHAR2(30 CHAR) NOT NULL
...
--,app_id                         NUMBER NOT NULL
--,sql_nm                         VARCHAR2(255 CHAR) NOT NULL
...
--(
--   PARTITION P2008  VALUES LESS THAN (TO_DATE('2009Jan01', 'YYYYMonDD')),
--   PARTITION P2009  VALUES LESS THAN (TO_DATE('2010Jan01', 'YYYYMonDD')),
--   PARTITION P2010  VALUES LESS THAN (TO_DATE('2011Jan01', 'YYYYMonDD')),
...
(
 user_id                         INTEGER NOT NULL
,user_nm                         VARCHAR2(80 CHAR) NOT NULL
...
(
 pmsn_id                       INTEGER NOT NULL
,app_id                        INTEGER NOT NULL
,pmsn_nm                       VARCHAR2(256 CHAR) NOT NULL
